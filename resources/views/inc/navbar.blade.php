	...
	<div class="container navbar">
		<div class="navbar-inner">
			...
			<div class="logo logo-image">
				<div class="brand">
					<a href="/" title="Ecole De Dessin">
						<span>Ecole De Dessin</span>
					</a>
		...
		<div class="container">
			...
			<div class="t3-spotlight t3-spotlight-1  row-fluid">
				...
				<div class="span3 " data-default="span3" data-xtablet="span6" data-tablet="span6">
						...
						<div class="module-inner">
							...
							<div class="module-ct">
								<div class="tagspopular">
									<ul >
										<li>
											<a href="/component/tags/tag/15-ecole">
                                          ecole</a>
										</li>
										<li>
											<a href="/component/tags/tag/16-dessin">
                                          dessin</a>
										</li>
										<li>
											<a href="/component/tags/tag/17-art">
                                          art</a>
										</li>
										<li>
											<a href="/component/tags/tag/19-events">
                                          events</a>
										</li>
										<li>
											<a href="/component/tags/tag/14-popup">
                                          popup</a>
										</li>
									</ul>
								</div>
					...
					<div class="t3-module module " id="Mod62">
						<div class="module-inner">
							<div class="module-ct">
				...
				<div class="span3 item-last" data-default="span3" data-xtablet="span6" data-tablet="span6">
					<div class="t3-module module " id="Mod100">
						<div class="module-inner">
							...
							<div class="module-ct">
								<div class="custom"  >
									<p>Use our search bar to find exactly what you need.</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="module-ct">
								<form class="form-search" action="/" method="post">
									<div class="search">
										...
										<input name="searchword" id="mod-search-searchword" maxlength="20"  class="input" type="text" size="20" placeholder="Search" />
